...
BANK_DATA = [
    ...
    # ── addition_first learner (foil) ──────────────────────────────────────
    {
        ...
        'foil_desc':         'apply addition and subtraction from right to left rather than left to right',
        'student':           'Ned',
    ...
    # ── add_before_exponent learner ─────────────────────────────────────────
    {
        ...
        'learnerAns':        '121',
        'expertAns':         '19',
        'correct_desc':      'add before applying the exponent instead of squaring first',
    ...
    # ── right_to_left learner (foil) ───────────────────────────────────────
    {
        ...
        'learnerAns':        '-5',
        'expertAns':         '15',
        'correct_desc':      'apply addition and subtraction from right to left rather than left to right',
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    {
        ...
        'learnerAns':        '0',
        'expertAns':         '10',
        'correct_desc':      'forget that subtracting a negative number changes the sign to addition',
        'foil_desc':         'apply addition and subtraction from right to left rather than left to right',
        'student':           'Quinn',
    ...
    },
    {
        ...
        'learnerAns':        '-1',
        'expertAns':         '11',
        'correct_desc':      'evaluate right to left',
        'foil_desc':         'do addition before multiplication',
        'student':           'Lee',
        'misconception_types': ['same_prio_rtl'],
    ...
    # Expert: 3 + 4×3 = 15
    {
        ...
        'learnerAns':        '99',
        'expertAns':         '15',
        'desc_shown':        'add before applying the exponent instead of squaring first',
        'student':           'Noah',
    ...
    # Expert: 8+5+6 = 19
    {
        ...
        'learnerAns':        '15',
        'expertAns':         '19',
        'desc_shown':        'forget that subtracting a negative number changes the sign to addition',
        'student':           'Olivia',
    ...
    # Expert: 6-2+12 = 16
    {
        ...
        'learnerAns':        '4',
        'expertAns':         '16',
        'desc_shown':        'apply addition and subtraction from right to left rather than left to right',
        'student':           'Owen',
