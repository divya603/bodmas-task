...
BANK_DATA = [
    ...
    },
    {
        ...
        'pool':              'A',
        'trace':             ['2×((3+4)×5)', '↓', '2×(3+4×5)', '↓', '2×(3+20)', '↓', '2×23', '↓', '46'],
        'learnerAns':        '46',
        'expertAns':         '70',
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    {
        ...
        'learnerAns':        '0',
        'expertAns':         '10',
        'correct_desc':      'treat subtracting a negative as regular subtraction',
        'foil_desc':         'work right to left when two operations have the same priority',
        'student':           'Quinn',
    ...
    },
    {
        ...
        'expertAns':         '19',
        'correct_desc':      'ignore the brackets and compute as if they weren\'t there',
        'foil_desc':         'only apply the multiplication to the first term inside the brackets',
        'student':           'Chris',
        'misconception_types': ['bracket_drop'],
    ...
    # Expert: 8+5+6 = 19
    {
        ...
        'learnerAns':        '15',
        'expertAns':         '19',
        'desc_shown':        'treat subtracting a negative as regular subtraction',
        'student':           'Olivia',
    ...
    # Expert: 1 + 4×5 = 21
    {
        ...
        'learnerAns':        '17',
        'expertAns':         '21',
        'desc_shown':        'only apply the multiplication to the first term inside the brackets',
        'student':           'Zoe',
