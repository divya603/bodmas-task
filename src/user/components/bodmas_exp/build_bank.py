...
BANK_DATA = [
    ...
    # ── addition_first learner ──────────────────────────────────────────────
    {
        ...
        'learnerAns':        '30',
        'expertAns':         '26',
        'correct_desc':      'Did addition before multiplication (computed `5+1` before `5×5`)',
        'foil_desc':         None,
        'student':           'Ned',
    ...
    },
    {
        ...
        'learnerAns':        '75',
        'expertAns':         '19',
        'correct_desc':      'Did addition before multiplication (computed `3+2` before `3×3`)',
        'foil_desc':         None,
        'student':           'Emma',
        'misconception_types': ['add_before_mult'],
        'inference_target':  'add_before_mult',
    },
    {
        ...
        'learnerAns':        '56',
        'expertAns':         '20',
        'correct_desc':      'Did addition before multiplication (computed `3+4` before `4×3`)',
        'foil_desc':         None,
        'student':           'Emily',
        'misconception_types': ['add_before_mult'],
        'inference_target':  'add_before_mult',
    },
    {
        ...
        'learnerAns':        '54',
        'expertAns':         '23',
        'correct_desc':      'Did addition before multiplication (computed `4+5` before `2×4`)',
        'foil_desc':         None,
        'student':           'Jake',
        'misconception_types': ['add_before_mult'],
        'inference_target':  'add_before_mult',
    },
    {
        ...
        'learnerAns':        '36',
        'expertAns':         '18',
        'correct_desc':      'Did addition before multiplication (computed `4-2` before `6×4`)',
        'foil_desc':         None,
        'student':           'Julian',
        'misconception_types': ['add_before_mult'],
        'inference_target':  'add_before_mult',
    },
    {
        ...
        'learnerAns':        '56',
        'expertAns':         '16',
        'correct_desc':      'Did addition before multiplication (computed `1+6` before `4×1`)',
        'foil_desc':         None,
        'student':           'Bob',
        'misconception_types': ['add_before_mult'],
        'inference_target':  'add_before_mult',
    ...
    # ── left_to_right_only learner ──────────────────────────────────────────
    {
        ...
        'learnerAns':        '58',
        'expertAns':         '34',
        'correct_desc':      'Did addition before multiplication (computed `24+5` before `5×2`)',
        'foil_desc':         None,
        'student':           'Mike',
        'misconception_types': ['add_before_mult'],
        'inference_target':  'add_before_mult',
    },
    {
        ...
        'learnerAns':        '125',
        'expertAns':         '29',
        'correct_desc':      'Did addition before multiplication (computed `24+1` before `1×5`)',
        'foil_desc':         None,
        'student':           'Jessica',
        'misconception_types': ['add_before_mult'],
        'inference_target':  'add_before_mult',
    },
    {
        ...
        'learnerAns':        '92',
        'expertAns':         '32',
        'correct_desc':      'Did addition before multiplication (computed `20+3` before `3×4`)',
        'foil_desc':         None,
        'student':           'Sam',
        'misconception_types': ['add_before_mult'],
        'inference_target':  'add_before_mult',
    },
    {
        ...
        'learnerAns':        '69',
        'expertAns':         '21',
        'correct_desc':      'Did addition before multiplication (computed `12+2` before `2×5`)',
        'foil_desc':         None,
        'student':           'Alex',
        'misconception_types': ['add_before_mult'],
        'inference_target':  'add_before_mult',
    },
    {
        ...
        'learnerAns':        '53',
        'expertAns':         '23',
        'correct_desc':      'Did addition before multiplication (computed `10+3` before `3×4`)',
        'foil_desc':         None,
        'student':           'Jordan',
        'misconception_types': ['add_before_mult'],
        'inference_target':  'add_before_mult',
    },
    {
        ...
        'learnerAns':        '40',
        'expertAns':         '24',
        'correct_desc':      'Did addition before multiplication (computed `18-2` before `4×2`)',
        'foil_desc':         None,
        'student':           'Taylor',
        'misconception_types': ['add_before_mult'],
        'inference_target':  'add_before_mult',
    ...
    # ── right_to_left learner ───────────────────────────────────────────────
    {
        ...
        'learnerAns':        '-8',
        'expertAns':         '16',
        'correct_desc':      'Evaluated right to left (computed `2+12` before `6-2`)',
        'foil_desc':         None,
        'student':           'Morgan',
    ...
    },
    {
        ...
        'learnerAns':        '-3',
        'expertAns':         '13',
        'correct_desc':      'Evaluated right to left (computed `3+8` before `8-3`)',
        'foil_desc':         None,
        'student':           'Casey',
        'misconception_types': ['same_prio_rtl'],
        'inference_target':  'same_prio_rtl',
    ...
    # ── bracket_ignorer learner ─────────────────────────────────────────────
    {
        ...
        'learnerAns':        '17',
        'expertAns':         '33',
        'correct_desc':      'Dropped the brackets (computed `(3+4)` as if there were no brackets)',
        'foil_desc':         None,
        'student':           'Riley',
    ...
    # ═══════════════════════════════════════════════════════════════════════════
    {
        ...
        'learnerAns':        '49',
        'expertAns':         '19',
        'correct_desc':      'Did addition before multiplication (computed `2+5` before `7×2`)',
    ...
    },
    {
        ...
        'learnerAns':        '0',
        'expertAns':         '6',
        'correct_desc':      'Did addition before multiplication (computed `3-3` before `6×3`)',
    ...
    },
    {
        ...
        'learnerAns':        '60',
        'expertAns':         '16',
        'correct_desc':      'Did addition before multiplication (computed `18+4` before `2×3`)',
        'foil_desc':         'Evaluated strictly right to left, ignoring operator priority',
        'student':           'Drew',
        'misconception_types': ['add_before_mult'],
        'inference_target':  'same_prio_rtl',   # foil names RTL
    ...
    # Expert: 2 + 3×6×10 = 182
    {
        ...
        'learnerAns':        '97',
        'expertAns':         '182',
        'desc_shown':        'Did addition before multiplication (computed `2+3` before `3×6`)',
        'student':           'Noah',
    ...
    # Expert: 3 + 2×4×3 = 27
    {
        ...
        'learnerAns':        '98',
        'expertAns':         '27',
        'desc_shown':        'Did addition before multiplication (computed `3+2` before `2×4`)',
        'student':           'Olivia',
        'misconception_types': ['add_before_mult', 'bracket_drop'],
        'inference_target':  'add_before_mult',
    },
    ...
    # Expert: 4+6-5+1 = 6
    {
        ...
        'learnerAns':        '12',
        'expertAns':         '6',
        'desc_shown':        'Did addition before multiplication (computed `4+2` before `2×3`)',
        'student':           'Lily',
    ...
    # Expert: 3+10-4+2 = 11
    {
        ...
        'learnerAns':        '10',
        'expertAns':         '11',
        'desc_shown':        'Did addition before multiplication (computed `3+5` before `5×2`)',
        'student':           'Mia',
        'misconception_types': ['add_before_mult', 'same_prio_rtl'],
        'inference_target':  'add_before_mult',
    },
    ...
    # Expert: 5+8-3+4 = 14
    {
        ...
        'learnerAns':        '21',
        'expertAns':         '14',
        'desc_shown':        'Did addition before multiplication (computed `5+2` before `2×4`)',
        'student':           'Owen',
        'misconception_types': ['add_before_mult', 'same_prio_rtl'],
        'inference_target':  'add_before_mult',
    },
    ...
    # Expert: 1 + 4×5×8 = 161
    {
        ...
        'learnerAns':        '56',
        'expertAns':         '161',
        'desc_shown':        'Dropped the brackets (treated `(2+6)` as if there were no brackets)',
        'student':           'Zoe',
        'misconception_types': ['add_before_mult', 'bracket_drop'],
        'inference_target':  'bracket_drop',
    },
    ...
    # Expert: 4 + 1×3×2 = 10
    {
        ...
        'learnerAns':        '86',
        'expertAns':         '10',
        'desc_shown':        'Dropped the brackets (treated `(6-4)` as if there were no brackets)',
        'student':           'Liam',
        'misconception_types': ['add_before_mult', 'bracket_drop'],
        'inference_target':  'bracket_drop',
    },
    ...
    # Expert: 6+5-3+2 = 10
    {
        ...
        'learnerAns':        '30',
        'expertAns':         '10',
        'desc_shown':        'Evaluated right to left (computed `3+2` before `35-3`)',
        'student':           'Ella',
        'misconception_types': ['add_before_mult', 'same_prio_rtl'],
        'inference_target':  'same_prio_rtl',
    },
    ...
    # Expert: 2+12-6+3 = 11
    {
        ...
        'learnerAns':        '9',
        'expertAns':         '11',
        'desc_shown':        'Evaluated right to left (computed `6+3` before `18-6`)',
        'student':           'Finn',
        'misconception_types': ['add_before_mult', 'same_prio_rtl'],
        'inference_target':  'same_prio_rtl',
    },
    ...
    # Expert: 1+12-2+5 = 16
    {
        ...
        'learnerAns':        '9',
        'expertAns':         '16',
        'desc_shown':        'Evaluated right to left (computed `2+5` before `16-2`)',
        'student':           'Nora',
        'misconception_types': ['add_before_mult', 'same_prio_rtl'],
        'inference_target':  'same_prio_rtl',
    },
...
def strip_example(text):
    ...
    e.g. "Did addition before multiplication (computed `5+1` before `5×5`)"
         → "Did addition before multiplication"
