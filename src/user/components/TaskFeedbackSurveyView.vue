    ...
    <TitleTwoCol leftFirst leftWidth="w-1/3" :responsiveUI="api.config.responsiveUI">
      ...
      <template #right>
        <div class="border border-border text-left bg-muted p-6 rounded-lg">
          ...
          <div class="mb-3">
            <label class="block text-md font-semibold text-foreground mb-2">
              Any general feedback? <span class="font-normal text-muted-foreground">(optional)</span>
            </label>
            <Textarea
          ...
          <div class="mb-3">
            <label class="block text-md font-semibold text-foreground mb-2">
              Any specific issues to report? <span class="font-normal text-muted-foreground">(optional)</span>
            </label>
            <Textarea
